...
public class WorldObject {
    ...
    public WorldObject(String name, String key, Pose2D pose2D, WorldObjectSize size) {
        this.name = name;
        this.key = key;
        this.pose2D = pose2D;
        this.size = size;
    }
    public WorldObject(String name, String key, Pose3D pose3D, WorldObjectSize size) {
        this.name = name;
        this.key = key;
        this.pose3D = pose3D;
        this.size = size;
