...
public class VelocityTBHControllerConstantBase extends TBHControllerConstants{
    ...
    public static double motorMaxPowerLimit;
    public static double FRONT_Kf_a;
    public static double FRONT_Kf_b;
    public static double FRONT_Kf_c;
    public static double REAR_Kf_a;
    public static double REAR_Kf_b;
    public static double REAR_Kf_c;
}
