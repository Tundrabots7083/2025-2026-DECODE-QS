...
public class REDdriveToIntakePoseGOAL implements ActionFunction {
    ...
    public REDdriveToIntakePoseGOAL(Telemetry telemetry, DriveTrainController driveTrainController) {
