...
import org.firstinspires.ftc.teamcode.behaviorControl.BehaviorTrees.BehaviorTreeComponents.ActionFunctions.actuators.driveTrain.MoveToCentralPositionBased_on_aprilTags;
import org.firstinspires.ftc.teamcode.behaviorControl.BehaviorTrees.BehaviorTreeComponents.ActionFunctions.actuators.driveTrain.Relocalize;
...
public class MoveToCenterBehaviorTree {
    ...
    public MoveToCenterBehaviorTree(LinearOpMode opMode) {
    ...
    private void Init() {
        ...
        this.root = new Sequence(
                Arrays.asList(
                        ...
                        new Action(new MoveToCentralPositionBased_on_aprilTags(telemetry, driveTrainController), telemetry)
                ),telemetry);
