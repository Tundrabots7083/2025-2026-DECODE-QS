...
public class ShooterTBHControllerConstants {
    ...
    public double FRONT_Kf_a = 0.0607; // a,b,c represent the values in
    public double FRONT_Kf_b = 1.42E-04; // a + bx + cx^2
    public double FRONT_Kf_c = 6.33E-09; // in the feedforward equation
