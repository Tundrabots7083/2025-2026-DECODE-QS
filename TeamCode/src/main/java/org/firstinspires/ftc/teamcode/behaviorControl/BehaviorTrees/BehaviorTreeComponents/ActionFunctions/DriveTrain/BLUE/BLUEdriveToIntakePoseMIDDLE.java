...
public class BLUEdriveToIntakePoseMIDDLE implements ActionFunction {
    ...
    public BLUEdriveToIntakePoseMIDDLE(Telemetry telemetry, DriveTrainController driveTrainController) {
