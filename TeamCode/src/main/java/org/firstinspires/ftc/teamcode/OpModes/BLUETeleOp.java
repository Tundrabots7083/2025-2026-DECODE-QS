...
import org.firstinspires.ftc.teamcode.behaviorControl.BehaviorTrees.BehaviorTree.TeleOp.BLUETeleOpBehaviorTree;
...
public class BLUETeleOp extends LinearOpMode {
    ...
    BLUETeleOpBehaviorTree mainBehaviorTree = null;
    ...
    private void initialize(LinearOpMode opMode) {
        ...
        this.mainBehaviorTree = new BLUETeleOpBehaviorTree(opMode, joinedTelemetry);
    }
