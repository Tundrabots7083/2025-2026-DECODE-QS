...
import org.firstinspires.ftc.teamcode.behaviorControl.BehaviorTrees.BehaviorTreeComponents.ActionFunctions.DriveTrain.RED.REDDriveForwardToIntake1;
...
import org.firstinspires.ftc.teamcode.behaviorControl.BehaviorTrees.BehaviorTreeComponents.ActionFunctions.DriveTrain.RED.REDdriveToIntakePoseMIDDLE;
import org.firstinspires.ftc.teamcode.behaviorControl.BehaviorTrees.BehaviorTreeComponents.ActionFunctions.DriveTrain.RED.REDdriveToLEAVEfront;
import org.firstinspires.ftc.teamcode.behaviorControl.BehaviorTrees.BehaviorTreeComponents.ActionFunctions.DriveTrain.RED.REDdriveToShootPoseFRONT;
...
public class REDFrontAutoBehaviorTree {
    ...
    public REDFrontAutoBehaviorTree(LinearOpMode opMode, Telemetry telemetry) {
    ...
    private void Init() {
        ...
        this.root = new Sequence(
                Arrays.asList(
                        ...
                        new Action(new REDdriveToShootPoseFRONT(telemetry, driveTrainController), telemetry),
                        new Action(new WaitForDrivetrainToArrive(telemetry, driveTrainController), telemetry),
                        new Action(new PauseAction(telemetry, 700), telemetry),
                        ...
                        new Action(new REDDriveForwardToIntake1(telemetry, driveTrainController), telemetry),
...
//                        new Action(new SortArtifacts(telemetry, spindexerController), telemetry),
                        ...
                        new ShootSubTree(opMode, telemetry).getRoot(),
                        new CalibrateSpindexerSubTree(opMode, telemetry).getRoot(),
                        new Action(new REDdriveToIntakePoseMIDDLE(telemetry, driveTrainController), telemetry),
                        new Action(new IntakeArtifacts(telemetry, intakeController), telemetry),
                        ...
                        new Action(new DetectArtifactColor(telemetry, rightColorSensorController), telemetry),
                        new Action(new TrackDetectedArtifact(telemetry, spindexerController, artifactTracker), telemetry),
                        new Action(new REDdriveToLEAVEfront(telemetry, driveTrainController), telemetry),
//                        new Action(new SortArtifacts(telemetry, spindexerController), telemetry),
                        new Action(new WaitForDrivetrainToArrive(telemetry, driveTrainController), telemetry),
                        new Action(new PauseAction(telemetry, 700), telemetry),
                        new ShootSubTree(opMode, telemetry).getRoot()
