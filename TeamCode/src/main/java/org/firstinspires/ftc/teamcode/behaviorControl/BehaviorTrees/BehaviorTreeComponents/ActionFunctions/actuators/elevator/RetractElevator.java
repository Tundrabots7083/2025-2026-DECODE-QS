...
public class RetractElevator  implements ActionFunction {
    Telemetry telemetry;
    ...
    public RetractElevator(Telemetry telemetry, ElevatorController elevatorController) {
    ...
    public Status perform(BlackBoard blackBoard) {
        ...
        if (!started) {
            elevatorController.moveToTargetPosition(targetPosition, Servo.Direction.REVERSE);
            started = true;
