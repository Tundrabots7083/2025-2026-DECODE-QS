...
public class BLUEDriveForwardToIntakeMIDDLE implements ActionFunction {
    ...
    public BLUEDriveForwardToIntakeMIDDLE(Telemetry telemetry, DriveTrainController driveTrainController) {
