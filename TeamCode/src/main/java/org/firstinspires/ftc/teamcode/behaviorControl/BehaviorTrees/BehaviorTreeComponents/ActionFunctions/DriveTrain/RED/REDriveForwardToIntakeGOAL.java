...
public class REDriveForwardToIntakeGOAL implements ActionFunction {
    ...
    private final Pose intakePose = new Pose(120, 35, Math.toRadians(0));
    private PathChain intakePath;


    public REDriveForwardToIntakeGOAL(Telemetry telemetry, DriveTrainController driveTrainController) {
