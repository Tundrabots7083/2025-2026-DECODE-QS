package org.firstinspires.ftc.teamcode.hardwareControl.actuators.carousel;
...
import org.firstinspires.ftc.teamcode.hardwareConfig.actuators.carousel.CarouselConstants;
import org.firstinspires.ftc.teamcode.hardwareConfig.actuators.carousel.CarouselMotionProfilerConstants;
import org.firstinspires.ftc.teamcode.hardwareConfig.actuators.carousel.CarouselPIDFControllerConstants;
...
public class CarouselController {
    ...
    private static final CarouselController INSTANCE = new CarouselController();
    ...
    public static CarouselController getInstance() {
        return INSTANCE;
    }

    private static void setupConstants(){
        try {
            Class.forName(CarouselConstants.class.getName());
            Class.forName(CarouselPIDFControllerConstants.class.getName());
            Class.forName(CarouselMotionProfilerConstants.class.getName());
    ...
    private void initializeMotor(HardwareMap hardwareMap){
        carouselMotor =  hardwareMap.get(DcMotorEx.class, MotorConstants.name);
        ...
        carouselMotor.setMode(MotorConstants.resetMode);
        carouselMotor.setMode(MotorConstants.mode);
        carouselMotor.setDirection(MotorConstants.direction);
    }
  ...
  /*        Kp= PIDFControllerConstants.kp;
    ...
    public double getCurrentPosition() {
        MotorConfigurationType motorType = carouselMotor.getMotorType();
        double ticksPerRev = motorType.getTicksPerRev();
        double currentTicks = carouselMotor.getCurrentPosition();
    ...
    public void moveToTargetPosition(double newTargetPosition){
        ...
        carouselMotor.setPower(pidPower);
